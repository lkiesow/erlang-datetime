...
rfc822_encode_test() ->
    [
     ?assertEqual("28 Feb 00 10:29 +0000", datetime:datetime_encode({{2000,2,28},{10,29,0}}, 'GMT', rfc822))
    ,?assertEqual("28 Feb 00 10:29 -0500", datetime:datetime_encode({{2000,2,28},{10,29,0}}, 'EST', rfc822))
    ].

rfc2822_decode_test() ->
    [
     ?assertEqual({{2014,3,9},{1,11,0}}, datetime:datetime_decode("Sat, 8 Mar 2014 01:11 GMT"))
...
rfc2822_encode_test() ->
    [
     ?assertEqual("28 Feb 2000 10:29 +0000", datetime:datetime_encode({{2000,2,28},{10,29,0}}, 'GMT', rfc822))
    ,?assertEqual("28 Feb 2000 10:29 -0500", datetime:datetime_encode({{2000,2,28},{10,29,0}}, 'EST', rfc822))
    ].
